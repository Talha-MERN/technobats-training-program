    ...
    <section className="bg-[#f4f0f5] py-16 px-6 md:px-12">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <h1
  className="text-4xl md:text-5xl font-bold leading-tight min-h-[12.5rem] md:min-h-[12.5rem]"
>
  <Typewriter
    onInit={(typewriter) => {
      typewriter
  ...
  />
          ...
          <div className="mt-10 bg-yellow-400 p-6 rounded-3xl text-white flex flex-wrap gap-4">
            ...
            <span className="bg-white text-black px-4 py-2 rounded-full">Web Design</span>
            <span className="bg-[#253238] px-4 py-2 rounded-full">Social Media</span>
            <span className="bg-white text-black px-4 py-2 rounded-full">Mobile Apps</span>
            <span className="bg-[#253238] px-4 py-2 rounded-full">E-commerce</span>
            <span className="bg-white text-black px-4 py-2 rounded-full">Analytics</span>
          </div>
        </div>
